...
#my_dict = dict(Система='Солнечная', Звезда='Солнце', Планеты=8, Млечный_путь=True)
#print(my_dict)
#my_dict['Спутник'] = 'Луна'
#print(my_dict)
#my_dict['Земля'] = 3
#print(my_dict)
#print(my_dict.get('Звезда'))
#print(my_dict.get('Сатурн'))
#del my_dict['Спутник']
#print(my_dict)



my_set = set(['Солнечная', 8, True, 8, 'Солнечная', 'Hello'])
print(my_set)
my_set.add('Орбита')
my_set.add(9)
print(my_set)
